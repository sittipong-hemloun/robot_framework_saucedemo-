...
Add Product By Include Text In Name
    [Arguments]    ${product_name}
    ${product}=    Get WebElement    xpath=//div[contains(@class, 'inventory_item_name') and contains(text(), '${product_name}')]
    Log    ${product}
...
Add Product To Cart If Found
    ...
    [Arguments]    ${product_name}
    Run Keyword And Ignore Error    Add Product By Include Text In Name    ${product_name}
...
Remove Product From Cart If Found
    ...
    [Arguments]    ${product_name}
    Run Keyword And Ignore Error    Remove Product By Include Text In Name    ${product_name}
    ${err}=    Run Keyword And Return Status
    ...    Page Should Contain Element
